...
<%
	...
	out.println("첫번쨰 연락처의 자리수 = " + tel1.length() + "<br>");
	out.println("두번쨰 연락처의 자리수 = " + tel2.length() + "<br>");
	out.println("세번쨰 연락처의 자리수 = " + tel3.length() + "<br>");
	...
	// 연락처의 첫 번쨰 자리 수는 3자리이어야합니다
	// 연락처의 두 , 세번쨰 자리 수는 4자리이어야합니다.
	// 요청 파라미터로 전달받은 연락처가
	// 연락처의 각 자리수를 초과하였을떄는
